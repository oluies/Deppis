...
- [ ] T024 [US1] Implement `BuddyRelationship` state (`Pending→Confirmed→Removed`), uniqueness/no-dup, and removal in `protocol-core/shared/src/main/scala/buddy/` (FR-002, FR-018)
